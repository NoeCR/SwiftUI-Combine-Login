...
class HeroesViewModel: ObservableObject {
    @Published var heroes: [HeroesModel]?
    ...
    func getHeros(filter: String){
        ...
        URLSession.shared
            ...
            .decode(type: [HeroesModel].self, decoder: JSONDecoder())
